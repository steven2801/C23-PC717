...
object SectionData {
    val sections = listOf(
        Section(
            ...
            title = "Selamat datang di Whole Foods Quality Detector!",
            description = "Whole Foods Quality Detector adalah sebuah aplikasi untuk mendeteksi apakah suatu makanan masih layak dikonsumsi."
        ),
        Section(
